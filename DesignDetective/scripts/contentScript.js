            ...
            for (const rule of sheet.cssRules) {
              if (rule.style) {
                if (
                  ...
                  !rule.style.fontFamily.includes("var")
                ) {
                  fontFamilies.add(rule.style.fontFamily);
                }
                if (
                  rule.style.color &&
                  !rule.style.color.includes("var") &&
                  (rule.style.color.includes("#") ||
                    rule.style.color.includes("rgba") ||
                    rule.style.color.includes("hsl") ||
                    rule.style.color.includes("rgb"))
                ) {
